...
\textcolor{black}{To enable an accurate deviation analysis, a controlled nonlinear transformation is proposed to reshape the feature space into a more symmetric geometry.} %To facilitate a sound deviation analysis, a controlled spatial transformation is proposed to reshape the signal geometry in the feature space, such that the abnormality classes symmetrically surround the normal class. 
